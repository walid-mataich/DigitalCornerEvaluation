...
const DashboardNavbar = () => {
  return (
    <div><nav className="block mb-2  px-4 py-2  bg-white shadow-md rounded-md lg:px-8 lg:py-3 ">
  <div className="container flex flex-wrap items-center justify-between  text-slate-800">
    <Link to="/general/dashboard" className="mr-4 block cursor-pointer py-1.5 text-base text-slate-800 font-semibold">
      Ocp
    </Link>
    ...
    <div className="hidden lg:block">
      <ul className="flex flex-col gap-2 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
        ...
        <li className="flex items-center p-1 text-sm gap-x-2 text-green-700">
          ...
          <Link to="/general/administrateurs" className="flex items-center">
            Administrateurs
          </Link>
        </li>
        <li className="flex items-center p-1 text-sm gap-x-2 text-green-700">
          ...
          <Link to="/general/centres" className="flex items-center">Centres</Link>
        </li>
        <li
